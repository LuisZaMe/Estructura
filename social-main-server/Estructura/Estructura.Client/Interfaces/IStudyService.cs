...
namespace Estructura.Client.Interfaces
{
    public interface IStudyService
    {
        ...
        Task<GenericResponse<List<Study>>> GetStudy(List<long> Id, long AnalystId, DateTime? startDate, DateTime? endDate, Common.Enums.ServiceTypes serviceType = Common.Enums.ServiceTypes.NONE, long interviewerId = 0, Common.Enums.StudyStatus studyStatus = Common.Enums.StudyStatus.NONE, long clientId = 0, long candidateId = 0, StudyProgressStatus studyProgressStatus = StudyProgressStatus.NONE, int currentPage = 0, int offset = 10);
        ...
        Task<GenericResponse<Study>> DeleteStudy(long Id);
